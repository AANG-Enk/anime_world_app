            ...
            children: [
              ...
              const Column(
                children: [
                  ...
                  ComponentTextTitle(title: 'Top Ranked Anime',filter: '', type: 'tv',),
                  SizedBox(height: 15.0,),
                  WidgetTopAnime(),
                  SizedBox(height: 25.0,),
                  ComponentTextTitle(title: 'Favorites Anime',filter: 'favorite', type: 'tv',),
                  SizedBox(height: 15.0,),
                  WidgetFavoritAnime(),
                  SizedBox(height: 25.0,),
                  ComponentTextTitle(title: 'Most Popular Anime',filter: 'bypopularity', type: 'tv',),
                  SizedBox(height: 15.0,),
                  WidgetPopularAnime(),
                  SizedBox(height: 25.0,),
                  ComponentTextTitle(title: 'Top Ranked Movie',filter: '', type: 'movie',),
                  SizedBox(height: 15.0,),
                  WidgetTopMovie(),
                ],
              )
